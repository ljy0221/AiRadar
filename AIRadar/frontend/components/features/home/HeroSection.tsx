export const HeroSection = () => {
  return (
    <section className="w-full relative flex flex-col items-center justify-center pt-32 pb-40 px-4 text-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[rgba(0,0,0,0.4)] to-[var(--color-bg-primary)] z-0 pointer-events-none" />
      <div 
      ...
      <div className="relative z-10 max-w-4xl flex flex-col items-center gap-6 mt-10">
        ...
        <p className="text-lg md:text-xl text-gray-200 mt-2 max-w-2xl font-light">
          Github 코드, Arxiv 논문, 글로벌 IT 기사를 교차 분석하여 실제 속도를 추적합니다.
        </p>
      </div>
    </section>
  );
