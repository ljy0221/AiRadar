  ...
  return (
    <div className="w-full bg-white dark:bg-[#1a1c2e] border border-gray-200 dark:border-gray-800 rounded-xl p-6 md:p-8 flex flex-col gap-8 shadow-sm sticky top-28">
      ...
      <div className="flex flex-col gap-3">
        <h4 className="text-sm font-bold text-gray-500">인간의 고유 영역</h4>
      ...
      <div className="flex flex-col gap-3">
        <h4 className="text-sm font-bold text-gray-500">추천 역량</h4>
        <ul className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-3">
        <h4 className="text-sm font-bold text-gray-500">유망 툴</h4>
      ...
      <p className="text-xs text-gray-500 leading-relaxed mt-2 border-t border-gray-100 dark:border-gray-800 pt-6 mt-auto">
